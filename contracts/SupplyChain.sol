...
address public owner;
  ...
  modifier checkSkuExists(uint _sku) {
    require(skuCount >= _sku);
    _;
  }
  ...
  constructor() public{
    ...
    // Nop. Default value for uints is 0.
  }
  ...
  function buyItem(uint sku) public payable checkSkuExists(sku) checkValue(sku) {
